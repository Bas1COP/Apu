...
void UpdateConfig() {
    ...
    if (conf.is_open()) {
        ...
        WritePair(Sense, yOffset);
        WritePair(Sense, xOffset);
        WritePair(Sense, yyOffset);
        WritePair(Sense, xxOffset);
...
bool ReadConfig(const std::string &configFile) {
    ...
    ReadPairFloat(Sense, yOffset);    
    ReadPairFloat(Sense, xOffset);    
    ReadPairFloat(Sense, yyOffset);    
    ReadPairFloat(Sense, xxOffset);    
...
bool ESPSave() {
    try {
        ...
        Config::Sense::DrawBox = Modules::ESP::DrawBox;
        Config::Sense::yOffset = Modules::ESP::yOffset;
        Config::Sense::xOffset = Modules::ESP::xOffset;
        Config::Sense::yyOffset = Modules::ESP::yyOffset;
        Config::Sense::xxOffset = Modules::ESP::xxOffset;
        return true;
    } catch (...) {
        return false;
    }
...
void LoadConfig() {
    ...
    Modules::ESP::DrawBox = Config::Sense::DrawBox;
    Modules::ESP::yOffset = Config::Sense::yOffset;
    Modules::ESP::xOffset = Config::Sense::xOffset;
    Modules::ESP::yyOffset = Config::Sense::yyOffset;
    Modules::ESP::xxOffset = Config::Sense::xxOffset;
