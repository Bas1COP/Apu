...
void SceneRenderUI() {
        if (ImGui::BeginTabItem("CONFIG", nullptr, ImGuiTabItemFlags_NoCloseWithMiddleMouseButton | ImGuiTabItemFlags_NoReorder)) {
            ...
            ImGui::SameLine();
            ImGui::Checkbox("Draw Box", &Modules::ESP::DrawBox);
            if (ImGui::IsItemHovered(ImGuiHoveredFlags_AllowWhenDisabled))
                ImGui::SetTooltip("Draw Rectangle on enemy");
            ImGui::SliderFloat("Plus Box yOffset", &Modules::ESP::yyOffset, 0, 100, "%.1f");
            ImGui::SliderFloat("Minus Box yOffset", &Modules::ESP::yOffset, 0, -100, "%.1f");
            ImGui::SliderFloat("Plus Box xOffset", &Modules::ESP::xOffset, 0, -100, "%.1f");
            ImGui::SliderFloat("Minus Box xOffset", &Modules::ESP::xxOffset, 0, 100, "%.1f");
